...
class Spectral_image():
    ...
    def calc_ZLPs(self, i, j, signal='EELS', **kwargs):
        ...
        def matching(signal, gen_i_ZLP, dE1):
            ...
            factor_NN = np.exp(
                - np.divide((self.deltaE[(self.deltaE < dE1) & (self.deltaE >= dE0)] - dE1) ** 2, delta ** 2))
    ...
    def load_ZLP_models_smefit(self, path_to_models="models", threshold_costs=1, name_in_path=False, plotting=False,
                               idx=None):

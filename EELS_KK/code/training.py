...
def determine_de1(image, dy_dx_clusters, y_smooth_clusters, shift_de1=0.7, plotde1=False, prob=True):
    """
...
def train_zlp_scaled(image, spectra, n_rep=500, n_epochs=30000, lr=1e-3, shift_dE1=0.7, shift_dE2=3,
                     ...
                     display_step=1000, bs_rep_num=0, plotde1=False, prob=True):
    """
    ...
    dE1 = determine_de1(image, smooth_dy_dx, spectra_smooth, shift_dE1, plotde1, prob)
    dE2 = shift_dE2 * dE1
